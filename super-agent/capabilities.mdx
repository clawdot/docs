...
<CardGroup cols={2}>
  ...
  <Card title="💬 社交记忆" icon="messages-square">
    **状态**: 🔜 即将上线
...
<AccordionGroup>
  <Accordion title="Super Agent 和普通聊天机器人有什么区别？" icon="circle-help">
...
<CardGroup cols={2}>
  <Card title="了解工作原理" icon="settings" href="/super-agent/how-it-works">
