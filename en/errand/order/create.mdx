...
| `payment_expire_at` | string | Payment deadline (Beijing time), 15 minutes after the order is placed; past that point the order may be closed automatically at any moment and the link stops working |
