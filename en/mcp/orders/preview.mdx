---
title: "preview_order"
description: "MCP tool, maps to REST POST /orders/preview — validate a priced cart and return final pricing, available coupons, and the preview_id used to place the order"
---
