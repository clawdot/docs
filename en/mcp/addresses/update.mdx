...
description: "MCP tool update_address — edit a saved address: change tag alone, or use suggestion_token + address_detail to move the location / detail"
---
...
| `ADDRESS_CREATE_REJECTED` | The platform refused to re-register the address at the new location (business reason). Retry with a different suggestion |
