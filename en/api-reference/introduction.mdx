...
<Note>
  API Keys and Agents are created in the [Portal](https://portal.clawdot.ai). The `consent_grant_id` (`cg_` prefix) is returned by the user binding flow — see [Authentication](/en/gateway/authentication).
</Note>
