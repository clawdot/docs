...
```
https://eleme-gateway.hicaspian.com/api/v1
```
...
<Note>
  API Keys and Agents are created in the [Portal](https://console.hicaspian.com/agents). The `consent_grant_id` (`cg_` prefix) is returned by the user binding flow — see [Authentication](/en/gateway/authentication).
</Note>
