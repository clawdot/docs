...
<CardGroup cols={2}>
  <Card title="🍽️ Food Delivery" icon="utensils">
    ...
    **Core Features**:
    ...
    - Preview order → Create order (two-step ordering, amounts in cents)
    - Real-time order tracking

    **Supported Platforms**: Meituan, Ele.me, various independent food delivery platforms

    [Learn More →](/en/super-agent/food-delivery)
  </Card>
  ...
  <Card title="💬 Social Memory" icon="messages-square">
    **Status**: 🔜 Coming Soon
...
|------|--------|--------|--------|--------|
| Food Delivery | ✅ Live | 2026-Q1 | Meituan, Ele.me, etc. | [View](/en/super-agent/food-delivery) |
...
<Tabs>
  <Tab title="Food Delivery" icon="utensils">
    **Currently Available**
    ...
    Details in [Food Delivery Documentation](/en/super-agent/food-delivery)
  </Tab>
...
<AccordionGroup>
  <Accordion title="What is the difference between Super Agent and regular chatbots?" icon="circle-help">
  ...
  <Accordion title="How does Super Agent ensure transaction safety?" icon="shield">
    ...
    1. **Two-Layer Authentication**: An API Key (`clw_` prefix) identifies the Agent, and a user consent grant (`cg_` prefix) identifies the authorized food-delivery user
    2. **Operation Confirmation**: Ordering is split into `preview_order` (preview the price) and `create_order` (place the order) — you must display the price and get user confirmation first, then place the order with the `confirmation_token` returned by the preview
...
<CardGroup cols={2}>
  <Card title="Learn How It Works" icon="settings" href="/en/super-agent/how-it-works">
    Understand how Super Agent calls Clawdot APIs to complete transactions
  </Card>

  <Card title="Try Food Delivery" icon="utensils" href="/en/super-agent/food-delivery">
    Most detailed food delivery ordering guide
  </Card>

  <Card title="View Product Roadmap" icon="map" href="/en/overview/roadmap">
