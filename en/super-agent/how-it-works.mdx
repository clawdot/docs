...
<Note>
  Create an Agent in the [Portal](https://portal.clawdot.ai) to get an API Key; obtain a user consent grant via the binding flow (SMS code or H5). For the full chain and fields, see [Order Flow](/en/gateway/order-flow) and [Authentication](/en/gateway/authentication).
</Note>
