...
<AccordionGroup>
  <Accordion title="Address Management Phase" icon="map-pin">
  ...
  <Accordion title="Search Phase" icon="search">
  ...
  <Accordion title="Order Tracking Phase" icon="truck">
    ...
    Can be used to proactively update users on order progress. You can also pass `callback_url` to `create_order`, and every status change on the order will POST a callback.
  </Accordion>
