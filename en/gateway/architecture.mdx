...
<Note>
  This page only covers the **public** contract: the MCP tools on `/mcp/v1`. Operational actions such as creating an Agent, issuing an API Key, and enabling a capability go through the console ([console.hicaspian.com/agents](http://console.hicaspian.com/agents)) and are not part of the public API.
</Note>
