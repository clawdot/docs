...
<Note>
  This page only covers the **public** contract: the `/api/v1/*` REST endpoints and the `/mcp/v1` MCP tools. Operational actions such as creating an Agent, issuing an API Key, and enabling a capability go through the Portal ([portal.clawdot.ai](http://console.hicaspian.com)) and are not part of the public API.
</Note>
