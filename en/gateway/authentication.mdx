...
<AccordionGroup>
  <Accordion title="Format and transport" icon="key">
    ...
    Passed via the connection-layer header `Authorization: Bearer clw_...`, required on every MCP request. Generated when you create an Agent in the console at `https://console.hicaspian.com/agents`.
  </Accordion>
