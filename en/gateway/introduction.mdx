...
3. **Unified interface** — Provide unified REST and MCP interfaces for AI Agent, hiding merchant differences
...
## Dual Protocol Entry Points

<Columns cols={2}>
  <Card title="REST API" icon="terminal" href="/api-reference/introduction">
    Standard RESTful interface, `/api/v1/*` paths, compatible with any HTTP client.
  </Card>
  <Card title="MCP Protocol" icon="plug" href="/gateway/mcp-overview">
    `/mcp` endpoint, 9 tools, directly connectable by MCP clients like Claude Desktop.
  </Card>
</Columns>
...
<Columns cols={2}>
  ...
  <Card title="Authentication Mechanism" icon="lock" href="/gateway/authentication">
    Dual-layer authentication system: API Key + User Token.
  </Card>
</Columns>
