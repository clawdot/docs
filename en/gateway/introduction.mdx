...
<Card title="MCP Protocol" icon="plug" href="/en/mcp/overview">
...
<Columns cols={3}>
  <Card title="Shop Search" icon="search">
  ...
  <Card title="Smart Ordering" icon="shopping-cart">
...
<Columns cols={2}>
  ...
  <Card title="Architecture Details" icon="network" href="/gateway/architecture">
